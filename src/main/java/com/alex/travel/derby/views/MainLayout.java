...
public class MainLayout extends AppLayout {
    ...
    public AppNav createNavigation() {
        ...
        nav.addItem(new AppNavItem("Travel", TravelView.class, "la la-file"));
        nav.addItem(new AppNavItem("Orders", OrdersView.class, "la la-file"));
        ...
        nav.addItem(new AppNavItem("Profile", AdminView.class, "la la-file"));
