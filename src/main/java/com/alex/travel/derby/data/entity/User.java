...
public class User  { // The user class acts as a schema template for the "user" table from postgresql db (via the @Entity() decorator) and it also defines the methods for CRUD operations, by means of get/set methods.
    @Id
    @GeneratedValue
    private Long id;
